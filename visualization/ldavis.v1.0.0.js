...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    var K, // number of topics
        ...
        color1 = "#333333", // baseline color for default topic circles and overall term frequencies
        color2 = "#8A120A"; // 'highlight' color for selected topics and term-topic frequencies
    ...
    function visualize(data) {
        ...
        svg.append("text")
            .text("Wine Cluster Distance Map")
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("Estimated term frequency within topic");
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.setAttribute("style", "font-family: sans-serif; font-size: 18px");
            ...
            lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 18px; margin-left: 80px");
        ...
        function reorder_bars(increase) {
            ...
            var dat2 = lamData.filter(function(d) {
                ...
                return d.Category == vis_state.topic;
            });
            // define relevance:
        ...
        function topic_on(circle) {
            ...
            //     .text("Most Relevant Terms for Topic " + topics + " (" + Freq + "% of tokens)");

            // grab the bar-chart data for this topic only:
            var dat2 = lamData.filter(function(d) {
                return d.Category == topics;
            });
